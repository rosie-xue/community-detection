...
# #情形1
# theta <- exp(1)^rnorm(n,0,sigma[1])
# #情形2
# theta <- exp(1)^rnorm(n,0,sigma[2])
#情形3
theta <- exp(1)^rnorm(n,0,sigma[3])
# #情形4
# theta <- exp(1)^rnorm(n,0,sigma[4])
# #情形5
# theta <- exp(1)^rnorm(n,0,sigma[5])

#归一化
theta <- 0.9*theta/max(theta)
